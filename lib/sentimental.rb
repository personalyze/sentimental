...
class Sentimental
  ...
  def load_defaults
    %w(slang en_words emojis).each do |filename|
  ...
  # make sure your string has space in between words
  # pre-process it in your own project
  def extract_words(string)
    string.to_s.downcase.split.flatten
  end
